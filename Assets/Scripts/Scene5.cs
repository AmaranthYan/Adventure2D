...
public class Scene5 : Scene {
	...
	protected override void Initialize() {
		base.Initialize();
		puppy.transform.position = new Vector3(6.65f, 1.65f, 0.0f);
		...
		bunny.transform.position = new Vector3(-7.0f, -1.57f, 0.0f);
	...
	protected override IEnumerator Narration() {
		...
		narrator.DisplayText("...even when they were apart...", 1.5f);
	}
